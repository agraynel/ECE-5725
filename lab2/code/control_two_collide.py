...
while 1:
    ...
    if flag == True:
        ...
        if ballrect2.top <= 0 or ballrect2.bottom >= height:
            speed2[1] = -speed2[1]
        # if two balls collide, swap speed
        if dist <= (radius1+radius2):
            ...
            #x1 = 1/3.0 *speed1[0] +2/3.0 *speed2[0]
            #x2 = 4/3.0 *speed1[0] -1/3.0 *speed2[0]
            #y1 = 1/3.0 *speed1[1] +2/3.0 *speed2[1]
            #y2 = 4/3.0 *speed1[1] -1/3.0 *speed2[1]
