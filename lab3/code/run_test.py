...
# setup GPIO output pins, channels, frequency and duty cycle.
GPIO.setup(18, GPIO.OUT)
p1=GPIO.PWM(18,46.51)
dc1 = 6.97
p1.start(0)

# setup GPIO output pins, channels, frequency and duty cycle.
GPIO.setup(12, GPIO.OUT)
p2=GPIO.PWM(12,46.51)
dc2 = 6.97
p2.start(0)
...
my_buttons = { 'quit':(290, 210),'start':(30,210)}
            ...
            if flag == False:
                ...
                if ((x-160)*(x-160)+(y-120)*(y-120)) < 1600:
                    ...
                    if p1_state==0:
                        ...
                        p1.ChangeDutyCycle(6.51)
                    elif p1_state==2:
                        p1.ChangeDutyCycle(7.44)
                    if p2_state==0:
                        p2.ChangeDutyCycle(0)
                    elif p2_state==1:
                        p2.ChangeDutyCycle(6.51)
                    elif p2_state==2:
                        p2.ChangeDutyCycle(7.44)
                    clk = time.time()    
